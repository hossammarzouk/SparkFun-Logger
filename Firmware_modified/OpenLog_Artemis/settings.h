...
struct struct_ADS122C04 {
  ...
  bool logInternalTemperature = false;
  bool logRawVoltage = true;
  bool useFourWireMode = false;
...
struct struct_settings {
  ...
  bool useGPIO11ForTrigger = true; // If true, use GPIO to trigger sensor logging
  bool fallingEdgeTrigger = false; // Default to falling-edge triggering (If false, triggering will be rising-edge)
