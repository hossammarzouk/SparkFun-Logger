...
SFE_UBLOX_GPS myGPS;
float Lat = 0; float Long = 0; int Alt = 0 ; int Fix = 0 ; int SIV = 0;
...
void setup() {
  ...
  Serial.println("Hossam modified Version");
  //beginQwiicDevices();
  qwiic.begin();
...
//   UpdatePPS(2, 100000);
//   if (UpdatePPS(2, 100000) == true){Serial.print("PPS good");}else{Serial.print("PPS BAd");};
